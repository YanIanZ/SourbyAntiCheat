# Contributing to SourbyAntiCheat

Thank you for your interest in contributing to SourbyAntiCheat. This document outlines the guidelines for
making pull
...
- SourbyAntiCheat is built using [Gradle](https://gradle.org/) kotlin scripts.
