...
import dev.yanianz.sourbyanticheat.checks.impl.elytra.ElytraC;
...
public class PacketPlayerRespawn extends PacketListenerAbstract {
    ...
    public void onPacketSend(PacketSendEvent event) {
        ...
        if (event.getPacketType() == PacketType.Play.Server.RESPAWN) {
            ...
            player.addRealTimeTaskNext(() -> {
                ...
                if (!SacAPI.INSTANCE.getSpectateManager().isSpectating(player.uuid)) {
    ...
    private boolean isWorldChange(SacPlayer player, WrapperPlayServerRespawn respawn) {
