...
import dev.yanianz.sourbyanticheat.utils.worldborder.BorderExtent;
import dev.yanianz.sourbyanticheat.utils.worldborder.RealTimeMovingBorderExtent;
import dev.yanianz.sourbyanticheat.utils.worldborder.StaticBorderExtent;
import dev.yanianz.sourbyanticheat.utils.worldborder.TickBasedMovingBorderExtent;
...
public class PacketWorldBorder extends Check implements PacketCheck {
    ...
    public PacketWorldBorder(SacPlayer playerData) {
        super(playerData);
