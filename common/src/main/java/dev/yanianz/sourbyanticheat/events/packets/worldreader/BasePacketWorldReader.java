package dev.yanianz.sourbyanticheat.events.packets.worldreader;
...
public class BasePacketWorldReader extends PacketListenerAbstract {
    ...
    public void handleMapChunkBulk(SacPlayer player, PacketSendEvent event) {
    ...
    public void handleMapChunk(SacPlayer player, PacketSendEvent event) {
    ...
    public void addChunkToCache(PacketSendEvent event, SacPlayer player, BaseChunk[] chunks, boolean isGroundUp, int chunkX, int chunkZ) {
    ...
    public void unloadChunk(SacPlayer player, int x, int z) {
        if (player == null) return;
        player.compensatedWorld.removeChunkLater(x, z);
    }

    public void handleBlockChange(SacPlayer player, PacketSendEvent event) {
    ...
    public void handleMultiBlockChange(SacPlayer player, PacketSendEvent event) {
