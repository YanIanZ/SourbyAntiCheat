...
import dev.yanianz.sourbyanticheat.checks.impl.badpackets.BadPacketsW;
...
public class PacketPlayerAttack extends PacketListenerAbstract {
    ...
    private void onAttack(PacketReceiveEvent event, SacPlayer player, int entityId) {
        if (isInvalidEntity(event, player, entityId)) return;
    ...
    private boolean isInvalidEntity(PacketReceiveEvent event, SacPlayer player, int entityId) {
