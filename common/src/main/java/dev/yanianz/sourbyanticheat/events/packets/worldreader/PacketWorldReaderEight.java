...
public class PacketWorldReaderEight extends BasePacketWorldReader {
    @Override
    public void handleMapChunkBulk(final SacPlayer player, final PacketSendEvent event) {
    ...
    @Override
    public void handleMapChunk(final SacPlayer player, final PacketSendEvent event) {
        PacketWrapper<?> wrapper = new PacketWrapper<>(event);
