...
public class GetBoundingBox {
    public static SimpleCollisionBox getCollisionBoxForPlayer(@NotNull SacPlayer player, double centerX, double centerY, double centerZ) {
        if (player.inVehicle()) {
    ...
    public static @NotNull SimpleCollisionBox getPacketEntityBoundingBox(SacPlayer player, double centerX, double minY, double centerZ, PacketEntity entity) {
    ...
    public static @NotNull SimpleCollisionBox getPlayerBoundingBox(@NotNull SacPlayer player, double centerX, double minY, double centerZ) {
    ...
    public static @NotNull SimpleCollisionBox getBoundingBoxFromPosAndSize(@NotNull SacPlayer player, double centerX, double minY, double centerZ, float width, float height) {
    ...
    public static double @NotNull [] getEntityDimensions(SacPlayer player, @NotNull PacketEntity entity) {
        final float scale = (float) entity.getAttributeValue(Attributes.SCALE);
    ...
    public static void expandBoundingBoxByEntityDimensions(@NotNull SimpleCollisionBox box, SacPlayer player, PacketEntity entity) {
