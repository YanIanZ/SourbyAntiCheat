...
import dev.yanianz.sourbyanticheat.utils.inventory.slot.EquipmentSlot;
import dev.yanianz.sourbyanticheat.utils.inventory.slot.ResultSlot;
import dev.yanianz.sourbyanticheat.utils.inventory.slot.Slot;
...
public class Inventory extends AbstractContainerMenu {
    ...
    public Inventory(SacPlayer player, CorrectingPlayerInventoryStorage inventoryStorage) {
        super(player);
