...
public class DynamicChorusPlant implements CollisionFactory {
    ...
    public CollisionBox getLegacyBoundingBox(SacPlayer player, ClientVersion version, int x, int y, int z) {
    ...
    public Set<BlockFace> getLegacyStates(SacPlayer player, ClientVersion version, int x, int y, int z) {
