...
public enum MenuType {
    ...
    public static AbstractContainerMenu getMenuFromID(SacPlayer player, Inventory playerInventory, MenuType type) {
        return switch (type) {
    ...
    public static AbstractContainerMenu getMenuFromString(SacPlayer player, Inventory inventory, String legacyType, int slots, int horse) {
