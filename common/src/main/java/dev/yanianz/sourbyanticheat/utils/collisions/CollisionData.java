package dev.yanianz.sourbyanticheat.utils.collisions;

import dev.yanianz.sourbyanticheat.player.SacPlayer;
import dev.yanianz.sourbyanticheat.predictionengine.movementtick.MovementTickerStrider;
import dev.yanianz.sourbyanticheat.utils.collisions.blocks.DoorHandler;
import dev.yanianz.sourbyanticheat.utils.collisions.blocks.DynamicChest;
import dev.yanianz.sourbyanticheat.utils.collisions.blocks.DynamicChorusPlant;
import dev.yanianz.sourbyanticheat.utils.collisions.blocks.DynamicStair;
import dev.yanianz.sourbyanticheat.utils.collisions.blocks.PistonBaseCollision;
import dev.yanianz.sourbyanticheat.utils.collisions.blocks.PistonHeadCollision;
import dev.yanianz.sourbyanticheat.utils.collisions.blocks.TrapDoorHandler;
import dev.yanianz.sourbyanticheat.utils.collisions.blocks.connecting.DynamicCollisionFence;
import dev.yanianz.sourbyanticheat.utils.collisions.blocks.connecting.DynamicCollisionPane;
import dev.yanianz.sourbyanticheat.utils.collisions.blocks.connecting.DynamicCollisionWall;
import dev.yanianz.sourbyanticheat.utils.collisions.datatypes.CollisionBox;
import dev.yanianz.sourbyanticheat.utils.collisions.datatypes.CollisionFactory;
import dev.yanianz.sourbyanticheat.utils.collisions.datatypes.ComplexCollisionBox;
import dev.yanianz.sourbyanticheat.utils.collisions.datatypes.DynamicCollisionBox;
import dev.yanianz.sourbyanticheat.utils.collisions.datatypes.HexCollisionBox;
import dev.yanianz.sourbyanticheat.utils.collisions.datatypes.HexOffsetCollisionBox;
import dev.yanianz.sourbyanticheat.utils.collisions.datatypes.NoCollisionBox;
...
public enum CollisionData implements CollisionFactory {
    ...
    public CollisionBox getMovementCollisionBox(SacPlayer player, ClientVersion version, WrappedBlockState block, int x, int y, int z) {
        return fetch(player, version, block, x, y, z).offset(x, y, z);
    }

    public CollisionBox getMovementCollisionBox(SacPlayer player, ClientVersion version, WrappedBlockState block) {
        if (this.box != null)
    ...
    @Override
    public CollisionBox fetch(SacPlayer player, ClientVersion version, WrappedBlockState block, int x, int y, int z) {
