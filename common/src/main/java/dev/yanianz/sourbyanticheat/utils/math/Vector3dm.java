package dev.yanianz.sourbyanticheat.utils.math;
...
public class Vector3dm implements Cloneable, Serializable {
    ...
    public double length() {
        return Math.sqrt(SacMath.square(this.x) + SacMath.square(this.y) + SacMath.square(this.z));
    }

    public double lengthSquared() {
        return SacMath.square(this.x) + SacMath.square(this.y) + SacMath.square(this.z);
    }
    ...
    public double distanceSquared(double oX, double oY, double oZ) {
        return SacMath.square(this.x - oX) + SacMath.square(this.y - oY) + SacMath.square(this.z - oZ);
    }
    ...
    public boolean isInSphere(@NotNull Vector3dm origin, double radius) {
        return SacMath.square(origin.x - this.x) + SacMath.square(origin.y - this.y) + SacMath.square(origin.z - this.z) <= SacMath.square(radius);
    }
    ...
    public int getBlockX() {
        return SacMath.mojangFloor(this.x);
    }
    ...
    public int getBlockY() {
        return SacMath.mojangFloor(this.y);
    }
    ...
    public int getBlockZ() {
        return SacMath.mojangFloor(this.z);
    }
