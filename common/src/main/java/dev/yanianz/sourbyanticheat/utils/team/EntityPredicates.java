package dev.yanianz.sourbyanticheat.utils.team;
...
//    public static Predicate<SacPlayer> canBePushedBy(SacPlayer player, PacketEntity entity, TeamHandler teamHandler) {
