package dev.yanianz.sourbyanticheat.utils.collisions.blocks;
...
public class DynamicStair implements CollisionFactory {
    ...
    public static EnumShape getStairsShape(SacPlayer player, WrappedBlockState originalStairs, int x, int y, int z) {
    ...
    private static boolean canTakeShape(SacPlayer player, WrappedBlockState stairOne, int x, int y, int z) {
