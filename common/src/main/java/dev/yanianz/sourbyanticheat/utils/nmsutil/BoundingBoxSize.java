...
import dev.yanianz.sourbyanticheat.utils.data.packetentity.*;
...
public final class BoundingBoxSize {
    ...
    public static float getWidth(SacPlayer player, PacketEntity packetEntity) {
    ...
    private static float getWidthMinusBaby(SacPlayer player, PacketEntity packetEntity) {
    ...
    public static Vector3d getRidingOffsetFromVehicle(PacketEntity entity, SacPlayer player) {
        ...
        if (entity instanceof PacketEntityTrackXRot xRotEntity) {
            ...
            if (EntityTypes.isTypeInstanceOf(entity.type, EntityTypes.BOAT)) {
                ...
                vec3 = yRot(SacMath.radians(-xRotEntity.interpYaw) - ((float) Math.PI / 2f), vec3);
                return new Vector3d(x + vec3.x, y + (double) f1, z + vec3.z);
            } else if (entity.type == EntityTypes.LLAMA) {
                float f = player.trigHandler.cos(SacMath.radians(xRotEntity.interpYaw));
                float f1 = player.trigHandler.sin(SacMath.radians(xRotEntity.interpYaw));
                ...
                float f = player.trigHandler.sin(SacMath.radians(xRotEntity.interpYaw));
                float f1 = player.trigHandler.cos(SacMath.radians(xRotEntity.interpYaw));
    ...
    public static float getHeight(SacPlayer player, PacketEntity packetEntity) {
    ...
    public static double getPassengerRidingOffset(SacPlayer player, PacketEntity packetEntity) {
    ...
    private static float getHeightMinusBaby(SacPlayer player, PacketEntity packetEntity) {
        final EntityType type = packetEntity.type;
    ...
    private static float getBabyScaleFactor(SacPlayer player, PacketEntity packetEntity) {
        final EntityType type = packetEntity.type;
