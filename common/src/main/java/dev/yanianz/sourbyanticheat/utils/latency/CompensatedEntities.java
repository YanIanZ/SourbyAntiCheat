...
import dev.yanianz.sourbyanticheat.utils.data.packetentity.dragon.PacketEntityEnderDragon;
import dev.yanianz.sourbyanticheat.utils.nmsutil.BoundingBoxSize;
import dev.yanianz.sourbyanticheat.utils.nmsutil.WatchableIndexUtil;
...
public class CompensatedEntities {
    ...
    public CompensatedEntities(SacPlayer player) {
        this.player = player;
