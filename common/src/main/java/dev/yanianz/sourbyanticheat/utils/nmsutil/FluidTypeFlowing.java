...
public class FluidTypeFlowing {
    public static Vector3dm getFlow(SacPlayer player, int originalX, int originalY, int originalZ) {
    ...
    private static boolean affectsFlow(SacPlayer player, int originalX, int originalY, int originalZ, int x2, int y2, int z2) {
        return isEmpty(player, x2, y2, z2) || isSame(player, originalX, originalY, originalZ, x2, y2, z2);
    }

    private static boolean isSolidFace(SacPlayer player, int originalX, int y, int originalZ, BlockFace direction) {
    ...
    public static boolean isEmpty(SacPlayer player, int x, int y, int z) {
    ...
    public static boolean isSame(SacPlayer player, int x1, int y1, int z1, int x2, int y2, int z2) {
