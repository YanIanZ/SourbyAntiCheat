...
import dev.yanianz.sourbyanticheat.utils.inventory.EquipmentType;
import dev.yanianz.sourbyanticheat.utils.inventory.Inventory;
import dev.yanianz.sourbyanticheat.utils.inventory.inventory.AbstractContainerMenu;
import dev.yanianz.sourbyanticheat.utils.inventory.inventory.MenuType;
import dev.yanianz.sourbyanticheat.utils.inventory.inventory.NotImplementedMenu;
import dev.yanianz.sourbyanticheat.utils.lists.CorrectingPlayerInventoryStorage;
...
public class CompensatedInventory extends Check implements PacketCheck {
    ...
    public CompensatedInventory(SacPlayer playerData) {
        super(playerData);
