...
//        }
    ...
    public SimpleCollisionBox offset(double x, double y, double z) {
        ...
        switch (offsetType) {
            ...
            case XZ:
                l = SacMath.hashCode(x, 0, z);
                offsetX = SacMath.clamp(((double) ((float) (l & 15L) / 15.0F) - 0.5) * 0.5, -maxHorizontalModelOffset, maxHorizontalModelOffset);
                offsetZ = SacMath.clamp(((double) ((float) (l >> 8 & 15L) / 15.0F) - 0.5) * 0.5, -maxHorizontalModelOffset, maxHorizontalModelOffset);
