...
public class Ray implements Cloneable {
    ...
    public Ray(SacPlayer player, double x, double y, double z, float xRot, float yRot) {
    ...
    public static Vector3dm calculateDirection(SacPlayer player, float xRot, float yRot) {
