package dev.yanianz.sourbyanticheat.utils.data.packetentity.dragon;
...
public final class PacketEntityEnderDragonPart extends PacketEntity {
    ...
    public PacketEntityEnderDragonPart(SacPlayer player, DragonPart part, double x, double y, double z, float width, float height) {
