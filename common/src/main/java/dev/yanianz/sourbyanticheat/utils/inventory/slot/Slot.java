...
public class Slot {
    ...
    public ItemStack safeTake(int p_150648_, int p_150649_, SacPlayer p_150650_) {
    ...
    public Optional<ItemStack> tryRemove(int p_150642_, int p_150643_, SacPlayer player) {
    ...
    // No override
    public boolean allowModification(SacPlayer player) {
        return this.mayPickup(player) && this.mayPlace(this.getItem());
    }

    public boolean mayPickup(SacPlayer player) {
        return true;
    }
}
