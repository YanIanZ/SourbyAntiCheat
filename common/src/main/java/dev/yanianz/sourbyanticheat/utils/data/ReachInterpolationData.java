// This file was designed and is an original check for SacBukkitLoaderPlugin
...
package dev.yanianz.sourbyanticheat.utils.data;
...
public class ReachInterpolationData {
    ...
    public ReachInterpolationData(SacPlayer player, SimpleCollisionBox startingLocation, TrackedPosition position, PacketEntity entity) {
    ...
    public ReachInterpolationData(SacPlayer player, SimpleCollisionBox finishedLoc, PacketEntity entity) {
...
//        int interpolationStepsLowBound = Math.min(this.interpolationStepsLowBound, this.cancelledLerpInterpolationStepsLowBound); // Temp test
    ...
    public void updatePossibleStartingLocation(SimpleCollisionBox possibleLocationCombined) {
        //SacBukkitLoaderPlugin.staticGetLogger().info(ChatColor.BLUE + "Updated new starting location as second trans hasn't arrived " + startingLocation);
        this.startingLocation = combineCollisionBox(startingLocation, possibleLocationCombined);
        //SacBukkitLoaderPlugin.staticGetLogger().info(ChatColor.BLUE + "Finished updating new starting location as second trans hasn't arrived " + startingLocation);
    }
