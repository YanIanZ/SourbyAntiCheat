package dev.yanianz.sourbyanticheat.utils.common.arguments;

import dev.yanianz.sourbyanticheat.platform.api.Platform;

import static dev.yanianz.sourbyanticheat.utils.common.arguments.ArgumentUtils.*;
...
public class CommonGrimArguments {
    ...
    /**
     * Enables "Fast Bypass" mode for chat messages sent by Sac.
     * <p>
