...
public class PacketEntityHorse extends PacketEntityTrackXRot implements JumpableEntity {
    ...
    public PacketEntityHorse(SacPlayer player, UUID uuid, EntityType type, double x, double y, double z, float xRot) {
    ...
    @Override
    public boolean canPlayerJump(SacPlayer player) {
        return this.hasSaddle();
    }

    @Override
    public void executeJump(SacPlayer player, Set<VectorData> possibleVectors) {
