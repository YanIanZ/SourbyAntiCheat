// This file was designed and is an original check for Sac
...
import dev.yanianz.sourbyanticheat.utils.data.ReachInterpolationData;
import dev.yanianz.sourbyanticheat.utils.data.TrackedPosition;
...
public class PacketEntity extends TypedPacketEntity {
    ...
    public PacketEntity(SacPlayer player, EntityType type) {
        super(type);
        this.uuid = null;
    ...
    public PacketEntity(SacPlayer player, UUID uuid, EntityType type, double x, double y, double z) {
        super(type);
        this.uuid = uuid;
        initAttributes(player);
        this.trackedServerPosition = new TrackedPosition();
    ...
    protected void initAttributes(SacPlayer player) {
    ...
    public void onFirstTransaction(boolean relative, boolean hasPos, double relX, double relY, double relZ, SacPlayer player) {
        if (hasPos) {
            if (relative) {
    ...
    public void setPositionRaw(SacPlayer player, SimpleCollisionBox box) {
