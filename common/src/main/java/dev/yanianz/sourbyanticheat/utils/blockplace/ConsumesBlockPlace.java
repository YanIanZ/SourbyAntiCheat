...
import dev.yanianz.sourbyanticheat.utils.collisions.AxisUtil;
...
public class ConsumesBlockPlace {
    public static boolean consumesPlace(@NotNull SacPlayer player, @NotNull WrappedBlockState state, @NotNull BlockPlace place) {
