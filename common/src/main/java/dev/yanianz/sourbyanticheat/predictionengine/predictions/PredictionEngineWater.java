...
public class PredictionEngineWater extends PredictionEngine {
    ...
    public static void staticVectorEndOfTick(SacPlayer player, Vector3dm vector, float swimmingFriction, double playerGravity, boolean isFalling) {
    ...
    public static Set<VectorData> transformSwimmingVectors(SacPlayer player, Set<VectorData> base) {
    ...
    public void guessBestMovement(float swimmingSpeed, SacPlayer player, boolean isFalling, double playerGravity, float swimmingFriction) {
