...
public class EntityFluidInteraction {
    ...
    public void update(final SacPlayer player, final boolean ignoreCurrent) {
        ...
        int minX = SacMath.floor(aabb.minX);
        int minY = SacMath.floor(aabb.minY);
        int minZ = SacMath.floor(aabb.minZ);
        int maxX = SacMath.ceil(aabb.maxX) - 1;
        int maxY = SacMath.ceil(aabb.maxY) - 1;
        int maxZ = SacMath.ceil(aabb.maxZ) - 1;
        ...
        int playerX = SacMath.floor(player.lastX);
        double playerEyeY = player.lastY + player.getEyeHeight() - 0.1111111119389534D;
        int playerZ = SacMath.floor(player.lastZ);
    ...
    public void applyCurrentTo(final FluidTag fluid, final SacPlayer entity, final double scale) {
    ...
    private static class Tracker {
        ...
        public void applyCurrentTo(final SacPlayer player, final double scale) {
