...
import dev.yanianz.sourbyanticheat.predictionengine.predictions.rideable.PredictionEngineNautilusWater;
...
public class MovementTickerNautilus extends MovementTickerLivingVehicle {
    ...
    public MovementTickerNautilus(SacPlayer player) {
        super(player);
    ...
    public float getRiddenSpeed(SacPlayer player) {
        PacketEntityNautilus nautilus = (PacketEntityNautilus) player.compensatedEntities.self.getRiding();
