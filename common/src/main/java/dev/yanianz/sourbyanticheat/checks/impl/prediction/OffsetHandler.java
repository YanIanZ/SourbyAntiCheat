...
@CheckData(name = "Simulation", stableKey = "sac.prediction.simulation", decay = 0.02)
public class OffsetHandler extends Check implements PostPredictionCheck {
    ...
    private static final CompletePredictionEvent.Channel COMPLETE_CHANNEL = SacAPI.INSTANCE.getEventBus().get(CompletePredictionEvent.class);

    public OffsetHandler(SacPlayer player) {
        super(player);
    }
