...
@CheckData(name = "PositionPlace", stableKey = "sac.scaffolding.position_place", description = "Placed a block against a hidden face")
public class PositionPlace extends BlockPlaceCheck {

    public PositionPlace(SacPlayer player) {
        super(player);
    }
