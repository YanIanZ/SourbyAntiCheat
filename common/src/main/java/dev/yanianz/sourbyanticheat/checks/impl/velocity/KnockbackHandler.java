package dev.yanianz.sourbyanticheat.checks.impl.velocity;
...
@CheckData(name = "AntiKB", stableKey = "sac.velocity.anti_knockback", alternativeName = "AntiKnockback", configName = "Knockback", setback = 10, decay = 0.025)
public class KnockbackHandler extends Check implements PostPredictionCheck {
    ...
    public KnockbackHandler(SacPlayer player) {
        super(player);
    }
