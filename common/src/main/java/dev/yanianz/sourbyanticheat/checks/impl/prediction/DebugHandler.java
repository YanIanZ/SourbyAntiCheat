package dev.yanianz.sourbyanticheat.checks.impl.prediction;

import dev.yanianz.sourbyanticheat.SacAPI;
import dev.yanianz.sourbyanticheat.checks.debug.AbstractDebugHandler;
...
public class DebugHandler extends AbstractDebugHandler implements PostPredictionCheck {
    ...
    private final Set<SacPlayer> listeners = new CopyOnWriteArraySet<>(new HashSet<>());
    ...
    public DebugHandler(SacPlayer player) {
        super(player);
    }
    ...
    public void onPredictionComplete(final PredictionComplete predictionComplete) {
        ...
        for (SacPlayer listener : listeners) {
        ...
        if (outputToConsole) {
            Sender consoleSender = SacAPI.INSTANCE.getPlatformServer().getConsoleSender();
    ...
    @Override
    public void toggleListener(SacPlayer player) {
