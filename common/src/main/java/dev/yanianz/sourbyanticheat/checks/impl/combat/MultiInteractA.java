...
@CheckData(name = "MultiInteractA", stableKey = "sac.multiinteract.multiple_targets", description = "Interacted with multiple entities in the same tick", experimental = true)
public class MultiInteractA extends Check implements PostPredictionCheck {
    ...
    public MultiInteractA(final SacPlayer player) {
        super(player);
    }
