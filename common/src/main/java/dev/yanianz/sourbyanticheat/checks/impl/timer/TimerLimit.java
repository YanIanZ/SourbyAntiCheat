...
@CheckData(name = "TimerLimit", stableKey = "sac.timer.limit", setback = 10)
public class TimerLimit extends Timer {
    ...
    public TimerLimit(SacPlayer player) {
        super(player);
    }
    ...
    public void onReload(ConfigManager config) {
        ...
        limitAbuseOverPing = config.getLongElse(getConfigName() + ".ping-abuse-limit-threshold", 3000L);
