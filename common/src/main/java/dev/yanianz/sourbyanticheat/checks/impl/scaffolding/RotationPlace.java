...
@CheckData(name = "RotationPlace", stableKey = "sac.scaffolding.rotation_place", description = "Placed a block while not looking at it")
public class RotationPlace extends BlockPlaceCheck {
    ...
    public RotationPlace(SacPlayer player) {
        super(player);
    }
