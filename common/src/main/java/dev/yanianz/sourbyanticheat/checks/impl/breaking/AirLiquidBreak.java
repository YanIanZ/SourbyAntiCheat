...
@CheckData(name = "AirLiquidBreak", stableKey = "sac.breaking.air_liquid_break", description = "Breaking a block that cannot be broken")
public class AirLiquidBreak extends Check implements BlockBreakCheck {
    ...
    public AirLiquidBreak(SacPlayer player) {
        super(player);
    }
    ...
    public void onBlockBreak(BlockBreak blockBreak) {
        ...
        int newTick = SacAPI.INSTANCE.getTickManager().currentTick;
        if (lastTick == newTick
