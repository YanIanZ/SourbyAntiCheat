...
@CheckData(name = "AirLiquidPlace", stableKey = "sac.scaffolding.air_liquid_place", description = "Placed a block against an invalid support")
public class AirLiquidPlace extends BlockPlaceCheck {
    public AirLiquidPlace(SacPlayer player) {
        super(player);
    }
    ...
    public void onBlockPlace(final BlockPlace place) {
        ...
        int currentTick = SacAPI.INSTANCE.getTickManager().currentTick;
