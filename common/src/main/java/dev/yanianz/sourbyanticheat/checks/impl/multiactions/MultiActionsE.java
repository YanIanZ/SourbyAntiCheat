...
@CheckData(name = "MultiActionsE", stableKey = "sac.multiactions.swing_while_using", description = "Swinging while using an item", experimental = true)
public class MultiActionsE extends Check implements PacketCheck {
    private boolean dropping;

    public MultiActionsE(SacPlayer player) {
        super(player);
    }
