...
public class NoClip extends Check implements PacketCheck {
    ...
    private int consecutiveInsideTicks;
    ...
    public void onPacketReceive(PacketReceiveEvent event) {
        ...
        if (consecutiveInsideTicks < 3) return;
        ...
        if (insideBuffer > 4) {
            flagAndAlertWithSetback(String.format("ticks=%d netty=%.1f/s spartan=%s",
                consecutiveInsideTicks,
