...
@CheckData(name = "FabricatedPlace", stableKey = "sac.scaffolding.fabricated_place", description = "Sent out of bounds cursor position")
public class FabricatedPlace extends BlockPlaceCheck {
    ...
    public FabricatedPlace(SacPlayer player) {
        super(player);
    }
