...
@CheckData(name = "BadPacketsF", stableKey = "sac.badpackets.duplicate_sprint", description = "Sent duplicate sprinting status", decay = 0.01)
public class BadPacketsF extends Check implements PacketCheck {
    ...
    public BadPacketsF(SacPlayer player) {
        super(player);
    }
